...
EXPORT_SYMBOL(ratelimit_pages); //taehwan
...
EXPORT_SYMBOL(dirty_expire_interval); //taehwan
...
EXPORT_SYMBOL(global_wb_domain); //taehwan
...
EXPORT_SYMBOL(global_dirtyable_memory); //taehwan
...
EXPORT_SYMBOL(domain_dirty_limits); //taehwan
...
EXPORT_SYMBOL(mdtc_calc_avail); //taehwan
...
EXPORT_SYMBOL(wb_position_ratio); //taehwan
...
EXPORT_SYMBOL(__wb_update_bandwidth); //taehwan
...
EXPORT_SYMBOL(dirty_poll_interval); //taehwan
...
EXPORT_SYMBOL(wb_max_pause); //taehwan
...
EXPORT_SYMBOL(__SCK__tp_func_balance_dirty_pages);
EXPORT_SYMBOL(__SCT__tp_func_balance_dirty_pages);
...
EXPORT_SYMBOL(bdp_ratelimits); //taehwan
...
EXPORT_SYMBOL(wb_over_bg_thresh); //taehwan
