...
EXPORT_SYMBOL(wb_wait_for_completion); //taehwan
...
EXPORT_SYMBOL(bdi_down_write_wb_switch_rwsem); //taehwan
...
EXPORT_SYMBOL(bdi_up_write_wb_switch_rwsem); //taehwan
...
EXPORT_SYMBOL(bdi_split_work_to_wbs); //taehwan
...
EXPORT_SYMBOL(wb_start_background_writeback); //taehwan
...
EXPORT_SYMBOL(queue_io); //taehwan
...
EXPORT_SYMBOL(inode_sleep_on_writeback); //taehwan
...
EXPORT_SYMBOL(writeback_sb_inodes); //taehwan
...
EXPORT_SYMBOL(__writeback_inodes_wb); //taehwan
...
EXPORT_SYMBOL(wb_check_old_data_flush); //taehwan
...
EXPORT_SYMBOL(wb_check_start_all); //taehwan
