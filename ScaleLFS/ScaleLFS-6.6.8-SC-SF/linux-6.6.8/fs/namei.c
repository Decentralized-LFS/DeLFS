...
inline void set_nameidata(struct nameidata *p, int dfd, struct filename *name,
...
inline umode_t vfs_prepare_mode(struct mnt_idmap *idmap,
...
EXPORT_SYMBOL(vfs_prepare_mode);
...
struct dentry *atomic_open(struct nameidata *nd, struct dentry *dentry,
				  struct file *file,
