...
define process name=dbwr,instances=$ndbwriters
{
  thread name=dbwr,memsize=$memperthread,useism
  {
    flowop aiowrite name=dbwrite-a,filesetname=datafiles,
        ...
        iosize=$iosize,workingset=$workingset,random,iters=150,opennext,directio=$directio,dsync
    flowop hog name=dbwr-hog,value=10000
    #flowop semblock name=dbwr-block,value=1000,highwater=2000
    flowop semblock name=dbwr-block,value=300,highwater=600
