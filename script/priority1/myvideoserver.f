...
#define fileset name=$actvidsname,path=$dir,size=$filesize,entries=$numactivevids,dirwidth=4,prealloc=20,paralloc,reuse=$reuseit
...
{
  thread name=vidwriter,memsize=10m,instances=4
