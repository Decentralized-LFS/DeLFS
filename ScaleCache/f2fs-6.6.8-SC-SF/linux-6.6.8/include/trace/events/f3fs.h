...
TRACE_EVENT(f3fs_map_blocks,
	TP_PROTO(struct inode *inode, struct f3fs_map_blocks *map, int flag,
		 int ret),
...
TRACE_EVENT(f3fs_replace_atomic_write_block,
...
DECLARE_EVENT_CLASS(f3fs_reset_zone,
...
DEFINE_EVENT(f3fs_reset_zone, f3fs_queue_reset_zone,
...
DEFINE_EVENT(f3fs_reset_zone, f3fs_issue_reset_zone,
...
TRACE_EVENT_CONDITION(f3fs_lookup_read_extent_tree_end,
...
TRACE_EVENT_CONDITION(f3fs_lookup_age_extent_tree_end,
...
TRACE_EVENT(f3fs_update_read_extent_tree_range,
...
TRACE_EVENT(f3fs_update_age_extent_tree_range,
