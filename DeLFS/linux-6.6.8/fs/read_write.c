...
ssize_t (*conn_vfs_write)(struct file *file, const char __user *buf, size_t count, loff_t *pos);
EXPORT_SYMBOL(conn_vfs_write);

ssize_t vfs_write(struct file *file, const char __user *buf, size_t count, loff_t *pos)
{
	if (conn_vfs_write)
		return (*conn_vfs_write)(file, buf, count, pos);
