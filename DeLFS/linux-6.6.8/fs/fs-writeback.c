...
EXPORT_SYMBOL(bdi_down_write_wb_switch_rwsem);
...
EXPORT_SYMBOL(bdi_up_write_wb_switch_rwsem);
...
EXPORT_SYMBOL(bdi_split_work_to_wbs);
...
EXPORT_SYMBOL(cgroup_writeback_umount); //taehwan
...
EXPORT_SYMBOL(inode_sleep_on_writeback);
...
EXPORT_SYMBOL(writeback_sb_inodes);
...
EXPORT_SYMBOL(__writeback_inodes_wb);
