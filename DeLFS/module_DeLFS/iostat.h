...
extern void f3fs_update_iostat(struct f3fs_sb_info *sbi, struct inode *inode,
...
#else
static inline void f3fs_update_iostat(struct f3fs_sb_info *sbi, struct inode *inode,
		enum iostat_type type, unsigned long long io_bytes) {}
