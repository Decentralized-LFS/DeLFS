...
static int utf8_casefold(const struct delfs_nls_table *table,
...
static const struct delfs_nls_ops utf8_ops = {
	.casefold = utf8_casefold,
};

static const struct delfs_nls_table nls_utf8 = {
	.ops = &utf8_ops,
	.version = UNICODE_AGE(12, 1, 0),
};

const struct delfs_nls_table *delfs_load_nls_table(int encoding)
{
