...
DELFS_MKFS=/home/syslab/workspace_hwan/DeLFS/delfs-mkfs/mkfs/mkfs.delfs
DELFS_KO=/home/syslab/workspace_hwan/DeLFS/DeLFS/module_DeLFS/delfs.ko
...
#filebench -f myfileserver-aged.f
./test_with_dstat_aged.sh  "${AGED_NVME_NUM}"
sudo umount "${AGED_MNT}" 2>/dev/null || true


sudo mount -t delfs "${UNAGED_DEV}" "${UNAGED_MNT}"
