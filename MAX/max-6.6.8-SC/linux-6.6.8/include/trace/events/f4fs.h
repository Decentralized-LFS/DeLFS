...
TRACE_EVENT(f4fs_map_blocks,
	TP_PROTO(struct inode *inode, struct f4fs_map_blocks *map, int flag,
		 int ret),
...
TRACE_EVENT(f4fs_replace_atomic_write_block,
...
DECLARE_EVENT_CLASS(f4fs_reset_zone,
...
DEFINE_EVENT(f4fs_reset_zone, f4fs_queue_reset_zone,
...
DEFINE_EVENT(f4fs_reset_zone, f4fs_issue_reset_zone,
...
TRACE_EVENT_CONDITION(f4fs_lookup_read_extent_tree_end,
...
TRACE_EVENT_CONDITION(f4fs_lookup_age_extent_tree_end,
...
TRACE_EVENT(f4fs_update_read_extent_tree_range,
...
TRACE_EVENT(f4fs_update_age_extent_tree_range,
